...
// Fréquence attribuée aux mots ajoutés à la main par l'enseignant. Le tri
...
// L'enseignant ne saisit qu'une seule forme par mot ; on la déclare dans le
 ...
 *
 * Y fusionne les mots ajoutés à la main par l'enseignant (API, base MySQL) :
